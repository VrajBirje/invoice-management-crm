...
//             userModel.createUser(pool, emailId, password , lastName, firstName, createdDate, createdId, updatedId, pincode, address, remark, city, state, country, phoneNo, roleId, companyName, (err, result) => {
//                 if (err) {
//                     console.error(err);
//                     return res.status(500).json({ error: 'Internal Server Error' });
//                 }
