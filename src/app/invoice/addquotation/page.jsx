...
export default function page() {
    ...
    return (
        <div className='customer-layout'>
            <Sidebar active="Invoice" settingsBool={false} masterBool={false} />
            <div className="mainpage-container">
                <Topbar name="Add Invoice" />
                    ...
                    <div className="addcustomer-personaldetails">
                        ...
                        <div className="personaldetails-content">
                            ...
                            <div className="pdetails-fieldvalue">
                                ...
                                <div className="pdetails-value2">
                                    <div className="pdetails-value-wrapper2">
                                        <input type="text" className='pdetails-input3' placeholder='Due on Reciept' />
                                        <IoIosArrowDown size={18} className='pdetails-icon2' />
                                    </div>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    {tableRows.map(count => (
                                        <tr key={count.id}>
                                            ...
                                            <td>
                                                <input style={{textAlign:"center"}} type="text" className='pdetails-input5' />
                                            </td>
                                            <td>
                                                <input style={{textAlign:"center"}} type="text" className='pdetails-input5' />
                                            </td>
